...
export default class Starships {
    ...
    private hiperdrive_rating: number;
    private MGLT: number;
    ...
    public constructor(_name: string = "", _model = "", _manufacturer = "", _cost_in_credits = 0, _length = 0, _max_atmosphering_speed = 0, _crew = 0, _passengers = 0, _cargo_capacity = 0, _consumables = "",
        _hiperdrive_rating = 0, _MGLT = 0, _starship_class = "", _pilots = [], _films = [], _created = new Date(), _edited = new Date(), _url = "") {
        this.name = _name;
        this.model = _model;
        ...
        this.hiperdrive_rating = _hiperdrive_rating;
        this.MGLT = _MGLT;
    ...
    public getHyperdriveRating(): number {
        return this.hiperdrive_rating;
    }
    public getMGLT(): number {
        return this.MGLT;
    }
    ...
    public static ToSpaceships = (data: any) => {
        let result = new Starships();
        ...
        result.starship_class = data["starship_class"];
